# jQuery-Mobile-Progress-Bar-with-Percentage v1.0.5 [![Build Status](https://travis-ci.org/tolis-e/jQuery-Mobile-Progress-Bar-with-Percentage.png?branch=master)](https://travis-ci.org/tolis-e/jQuery-Mobile-Progress-Bar-with-Percentage)
